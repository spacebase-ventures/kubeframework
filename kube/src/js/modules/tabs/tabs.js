    ...
    $K.add('module', 'tabs', {
        ...
        _buildBoxes: function () {
            this.$tabsControls.each(function (node, i) {
                ...
                this.$boxes.add($box);
                this.$extraContent.add(this._getExtraContent($tab));
        ...
        _open: function ($tab) {
            ...
            this.$extraContentActive = this._getExtraContent(this.$tabActive);

            this.$boxes.addClass('is-hidden').removeClass('is-open');
            this.$boxActive.removeClass('is-hidden').addClass('is-open');

            this.$extraContent.addClass('is-hidden').removeClass('is-open');
            this.$extraContent.addClass('is-hidden').removeClass('is-open');
            this.$extraContentActive.removeClass('is-hidden').addClass('is-open');
        },
        _getBox: function ($tab) {
            return $K.dom($tab.attr('href'));
        },
        _getExtraContent: function ($tab) {
            return $K.dom($tab.data('extra-content'));
        },
